...
public class NaturaKama extends ItemSword
{
	...
	public boolean itemInteractionForEntity(ItemStack itemstack, EntityPlayer player, EntityLivingBase entity)
	{
		...
		if (entity instanceof IShearable)
		{
			...
			if (target.isShearable(itemstack, entity.worldObj, new BlockPos((int) entity.posX, (int) entity.posY, (int) entity.posZ)))
			{
				List<ItemStack> drops = target.onSheared(itemstack, entity.worldObj, new BlockPos((int) entity.posX, (int) entity.posY, (int) entity.posZ), EnchantmentHelper.getEnchantmentLevel(Enchantment.fortune.effectId, itemstack));
	...
	public boolean onBlockStartBreak(ItemStack itemstack, BlockPos pos, EntityPlayer player)
	{
		...
		Block id = player.worldObj.getBlockState(pos).getBlock();
