...
public class WhiteTreeGen extends WorldGenerator
{
    ...
    void placeBlockLine (int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, Block b, World world)
    {
        ...
        if (var4[var6] != 0)
        {
            ...
            {
                posArray[var6] = MathHelper.floor_double(par1ArrayOfInteger[var6] + var15 + 0.5D);
                posArray[var7] = MathHelper.floor_double(par1ArrayOfInteger[var7] + var15 * var10 + 0.5D);
                posArray[var8] = MathHelper.floor_double(par1ArrayOfInteger[var8] + var15 * var12 + 0.5D);
    ...
    int checkBlockLine (int[] par1ArrayOfInteger, int[] par2ArrayOfInteger, World world)
    {
        ...
        else
        {
            ...
            for (compare = intArray[iter] + increase; returnValue != compare; returnValue += increase)
            {
                ...
                arrayCopy[var6] = MathHelper.floor_double(par1ArrayOfInteger[var6] + returnValue * var9);
                arrayCopy[var7] = MathHelper.floor_double(par1ArrayOfInteger[var7] + returnValue * var11);
