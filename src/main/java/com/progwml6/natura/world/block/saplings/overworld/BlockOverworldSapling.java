...
public class BlockOverworldSapling extends BlockSapling
{
    ...
    public void generateTree(@Nonnull World worldIn, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull Random rand)
    {
        ...
        {
        case MAPLE:
            log = NaturaWorld.overworldLog.getDefaultState().withProperty(BlockOverworldLog.TYPE, BlockOverworldLog.LogType.MAPLE);
            leaves = NaturaWorld.overworldLeaves.getDefaultState().withProperty(BlockOverworldLog.TYPE, BlockOverworldLog.LogType.MAPLE);

            gen = new OverworldTreeGenerator(4, 2, log, leaves);

            break;
        case SILVERBELL:
            log = NaturaWorld.overworldLog.getDefaultState().withProperty(BlockOverworldLog.TYPE, BlockOverworldLog.LogType.SILVERBELL);
            leaves = NaturaWorld.overworldLeaves.getDefaultState().withProperty(BlockOverworldLog.TYPE, BlockOverworldLog.LogType.SILVERBELL);

            gen = new OverworldTreeGenerator(4, 2, log, leaves);

            break;
        case AMARANTH:
            log = NaturaWorld.overworldLog.getDefaultState().withProperty(BlockOverworldLog.TYPE, BlockOverworldLog.LogType.AMARANTH);
            leaves = NaturaWorld.overworldLeaves.getDefaultState().withProperty(BlockOverworldLog.TYPE, BlockOverworldLog.LogType.AMARANTH);

            gen = new OverworldTreeGenerator(9, 8, log, leaves);

            break;
        case TIGER:
            log = NaturaWorld.overworldLog.getDefaultState().withProperty(BlockOverworldLog.TYPE, BlockOverworldLog.LogType.TIGER);
            leaves = NaturaWorld.overworldLeaves.getDefaultState().withProperty(BlockOverworldLog.TYPE, BlockOverworldLog.LogType.TIGER);
