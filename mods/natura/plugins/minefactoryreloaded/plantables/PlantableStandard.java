...
public class PlantableStandard implements IFactoryPlantable
{
    ...
    public boolean canBePlantedHere (World world, int x, int y, int z, ItemStack stack)
    {
        ...
        return (Block.blocksList[_plantedBlockId].canPlaceBlockAt(world, x, y, z) && Block.blocksList[_plantedBlockId].canBlockStay(world, x, y, z))
                || (Block.blocksList[_plantedBlockId] instanceof IPlantable && Block.blocksList[groundId] != null && Block.blocksList[groundId].canSustainPlant(world, x, y, z, ForgeDirection.UP,
                        ((IPlantable) Block.blocksList[_plantedBlockId])));
    }
