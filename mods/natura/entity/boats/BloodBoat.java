...
public class BloodBoat extends Entity
{
    ...
    public boolean attackEntityFrom (DamageSource damagesource, int i)
    {
        ...
        if (getDamageTaken() > 40)
        {
            ...
            for (int j = 0; j < 5; j++)
            {
                entityDropItem(new ItemStack(NContent.tree, 1, 4), 0F);
            }
    ...
    public void onUpdate ()
    {
        ...
        for (int j = 0; j < i; j++)
        {
            ...
            if (worldObj.isAABBInMaterial(axisalignedbb, Material.water) || worldObj.isAABBInMaterial(axisalignedbb, Material.lava))
            {
                d += 1.0D / (double) i;
            }
        }
