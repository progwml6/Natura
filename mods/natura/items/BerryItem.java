...
import mods.natura.potion.NaturaPotion;
...
{
    public Icon[] icons;
    public String[] textureNames = new String[] { "rasp", "blue", "black", "geo", "straw", "cran", "lingon", "belladonna" };
    ...
    {
        if (par1ItemStack.itemDamage == 7)
            par3EntityPlayer.addPotionEffect(new PotionEffect(NaturaPotion.naturaPoison.id, 20 * 20, 0));
