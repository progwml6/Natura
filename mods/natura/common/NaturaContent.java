	...
	public void addRecipes()
	{
		...
		for (int i = 1; i <= 2; i++)
		{
			...
			GameRegistry.addRecipe(new ItemStack(Item.cake, 1), "AAA", "BEB", " C ", 'A', Item.bucketMilk, 'B', Item.sugar, 
					'C', new ItemStack(plantItem, 1, i), 'E', Item.egg );
		}
		...
		//Clouds
		GameRegistry.addRecipe(new ItemStack(Item.coal, 1, 1), "cc", "cc", 'c', new ItemStack(cloud, 1, 2) );
		GameRegistry.addRecipe(new ItemStack(Item.gunpowder, 1, 0), "cc", "cc", 'c', new ItemStack(cloud, 1, 3) );
		...
		ItemStack[] plankStacks = new ItemStack[] { new ItemStack(planks, 1, 0), new ItemStack(planks, 1, 1),
			 new ItemStack(planks, 1, 2), new ItemStack(planks, 1, 3), new ItemStack(planks, 1, 5)};
		ItemStack[] logStacks = new ItemStack[] { new ItemStack(tree, 4, 0), new ItemStack(tree, 4, 1),
				new ItemStack(tree, 4, 2), new ItemStack(tree, 4, 3), new ItemStack(redwood, 1, 1)  };
